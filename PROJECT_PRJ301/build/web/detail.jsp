<%-- 
    Document   : detail
    Created on : Mar 12, 2023, 12:48:12 PM
    Author     : Acer
--%>
                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="Home.jsp" class="nav-item nav-link">Shop</a>
        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-5 pb-5">
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    ...
                    <a class="carousel-control-prev" href="${o.image}" data-slide="prev">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="media mb-4">
                                    <img src="Shop/img/user.jpg" alt="Image" class="img-fluid mr-3 mt-1" style="width: 45px;">
